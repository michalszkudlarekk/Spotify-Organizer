...
namespace SpotifyOrganizer.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumsSong", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlbumsSong_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumsSong_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAlbums_SpotifyUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumsSong_AlbumId",
                table: "AlbumsSong",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_AlbumsSong_SongId",
                table: "AlbumsSong",
                column: "SongId");
